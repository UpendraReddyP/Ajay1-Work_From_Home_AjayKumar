...
app.use(cors({
  origin: [
    ...
    "http://13.51.201.27:3077",
    "http://127.0.0.1:5500",
    "http://13.51.201.27:5500",
    "http://127.0.0.1:5501",
    "http://127.0.0.1:5503", // Added to allow requests from this origin
    "http://13.51.201.27:5503", // Added to allow requests from this origin
    "http://13.51.201.27:8143",
    "http://13.51.201.27:8144"
  ],
...
// Start server
app.listen(port, () => {
  console.log(`Server running on http://13.51.201.27:${port}`);
});